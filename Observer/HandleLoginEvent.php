...
class HandleLoginEvent implements \Magento\Framework\Event\ObserverInterface
{
    private $curl;
    ...
    private function loginEvent($api_key){
        $this->curl->get('http://127.0.0.1:3000/?status=login&api_key='.$api_key);
    }
